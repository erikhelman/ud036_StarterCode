# This file creates the instances of the Movie class to be displayed
# in the web page
...
star_wars_force_awakens = media.Movie(
    'The Force Awakens',
    'Three decades after the defeat of the Galactic Empire, the First Order'
    ' attempts to rule the galaxy and only a ragtag group of heroes can '
    'stop them.',
...
deadpool = media.Movie(
    'Deadpool',
    'A fast-talking mercenary is subjected to a rogue experiment that leaves '
    'him with accelerated healing powers and a quest for revenge.',
    'images/deadpool.jpg',
...
raiders_of_the_lost_ark = media.Movie(
    ...
    'Archaeologist and adventurer Indiana Jones is hired by the U.S. '
...
movies = [star_wars_force_awakens, deadpool, raiders_of_the_lost_ark,
          guardians_of_the_galaxy, matrix, memento]
